...
namespace TcgEngine
{
    ...
    public class GameplayData : ScriptableObject
    {
        ...
        public int main_deck_size = 35;
        public int extra_deck_size = 4;
        public int deck_four_of_limit = 4;      //Max number of card types that can have 4 copies
        public string divine_trait_id = "";     //Trait ID for Divine Mark (神迹), cards with this trait max 1 per deck
