...
namespace TcgEngine
{
    public enum CardType
    {
        ...
        Secret = 40,
        Equipment = 50,
        Talent = 60,    //天赋卡：可升级(Lv1->Lv2->Lv3)，可驻守/被侵占
        TalentCreature = 65, //天赋生物卡（特殊规则）
    }
    ...
    public class CardData : ScriptableObject
    {
        ...
        {
            return type == CardType.Character || type == CardType.Artifact || type == CardType.Talent || type == CardType.TalentCreature;
        }
        ...
        {
            return type == CardType.Talent;
        }

        public bool IsTalentCreature()
        {
            return type == CardType.TalentCreature;
        }

        public bool IsTalentOrTalentCreature()
        {
            return type == CardType.Talent || type == CardType.TalentCreature;
        }
